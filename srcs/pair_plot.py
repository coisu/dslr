...
def plot_pair(data, output_path="outputs/pair_plot.png"):
    """
    ...
    numeric_data.to_csv("datasets/standardized_data2.csv", index=True)
    print("\n Standardized data saved to datasets/standardized_data2.csv")
    print("\n\n>> Scaled data oreview:")
...
if __name__ == "__main__":
    ...
    output_path = "outputs/pair_plot.png"
