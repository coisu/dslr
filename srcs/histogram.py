...
def plot_std_line_graph(variance_std_data, output_dir="outputs/histograms", output_file="std_line_graph.png"):
...
def plot_histogram(data, columns, hue_column="Hogwarts House", output_dir="outputs/histograms"):
...
if __name__ == "__main__":
    ...
    plot_histogram(data, numeric_columns, output_dir="outputs/histograms")
