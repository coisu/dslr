...
def plot_scatter(data, feature1, feature2, output_path="outputs/scatter_plot.png"):
...
def find_top_n_similar_features(data, n=5, scale_data=True):
    ...
    numeric_data.to_csv("datasets/standardized_data.csv", index=True)
    print("\n Standardized data saved to datasets/standardized_data.csv")
...
if __name__ == "__main__":
    ...
    for rank, (feature1, feature2) in enumerate(top_pairs, start=1):
        ...
        output_dir = "outputs/scatter_plots"
